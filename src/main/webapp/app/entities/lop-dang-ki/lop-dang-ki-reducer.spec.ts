...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOPDANGKI_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOPDANGKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOPDANGKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOPDANGKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOPDANGKI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOPDANGKI actions', async () => {
      const expectedActions = [
        {
