...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './nien-khoa.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NIENKHOA_LIST actions', async () => {
    ...
    it('dispatches FETCH_NIENKHOA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NIENKHOA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NIENKHOA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NIENKHOA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NIENKHOA actions', async () => {
      const expectedActions = [
        {
