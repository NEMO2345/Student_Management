...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './hoc-phan.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOCPHAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_HOCPHAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HOCPHAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HOCPHAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HOCPHAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HOCPHAN actions', async () => {
      const expectedActions = [
        {
