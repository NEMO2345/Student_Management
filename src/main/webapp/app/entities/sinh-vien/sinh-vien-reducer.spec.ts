...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sinh-vien.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SINHVIEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_SINHVIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SINHVIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SINHVIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SINHVIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SINHVIEN actions', async () => {
      const expectedActions = [
        {
