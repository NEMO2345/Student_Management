...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './nganh-hoc.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NGANHHOC_LIST actions', async () => {
    ...
    it('dispatches FETCH_NGANHHOC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NGANHHOC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NGANHHOC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NGANHHOC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NGANHHOC actions', async () => {
      const expectedActions = [
        {
