...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './giao-vien.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GIAOVIEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_GIAOVIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GIAOVIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GIAOVIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GIAOVIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GIAOVIEN actions', async () => {
      const expectedActions = [
        {
