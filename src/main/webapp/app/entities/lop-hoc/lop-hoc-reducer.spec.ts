...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './lop-hoc.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOPHOC_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOPHOC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOPHOC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOPHOC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOPHOC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOPHOC actions', async () => {
      const expectedActions = [
        {
