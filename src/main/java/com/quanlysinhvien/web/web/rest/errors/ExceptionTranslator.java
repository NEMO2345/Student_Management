package com.quanlysinhvien.web.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.quanlysinhvien.web.service.EmailAlreadyUsedException ||
            ex instanceof com.quanlysinhvien.web.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.quanlysinhvien.web.service.InvalidPasswordException
